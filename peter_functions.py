...
def load_mat_file(num_subject, chop, option):

    if option == 1:
        file_name = f"/Users/goldenyoo/Library/Mobile Documents/com~apple~CloudDocs/BioCAS_prepare/BCIIV_2a_mat/myData/Aug/Calib_data_{num_subject}_chop_{chop}.mat"
    elif option == 2:
        file_name = f"/Users/goldenyoo/Library/Mobile Documents/com~apple~CloudDocs/BioCAS_prepare/BCIIV_2a_mat/myData/Aug/Eval_data_{num_subject}_chop_{chop}.mat"
        ...
        for epoch in range(config.epochs):
            ...
            with torch.no_grad():
                ...
                if epoch % 100 == 0:
                    ...
                    print(
                        f"Val accuracy: {round(correct/len(val_DL.dataset),3)}"
                    )
            scheduler.step()
